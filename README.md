# Typed Koa Github Webhook Handler  [![Build Status](https://travis-ci.org/aendrew/typed-koa-github-webhook-handler.svg?branch=master)](https://travis-ci.org/aendrew/typed-koa-github-webhook-handler)
